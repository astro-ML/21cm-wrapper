...
class mcmc_aies(Simulation):
    def __init__(self, k_bins = np.linspace(1e-1, 2, 20), z_bins = 10, nwalker = 16, steps = 5000, debug = False):
    ...
    # lambda functions can not be pickled!, rewrite with normal functions
    def run(self, init_params_ranges, llh, lp,
            fname: str = "./chain.h5"):
